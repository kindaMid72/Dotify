        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="flex flex-col justify-center items-center w-[450px] border-2 border-transparent rounded-xl py-6 px-8 font-mono [box-shadow:0px_0px_50px_#c7c7c7]">
                ...
                <div className="w-full flex flex-col mt-5">
                    ...
                    {/* login button */}
                    <button className="w-full border-2 border-transparent bg-blue-600 rounded-lg py-2 mt-5 text-white font-[800]">Log in</button>
                </div>

                {/* sign up section */}
                <div>
                    <p className="text-center mt-7 text-gray-500">Don't have an account? <Link to="#" className="text-blue-600 hover:underline font-extrabold">Sign up for free</Link></p>
                </div>
