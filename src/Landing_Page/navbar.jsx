        ...
        <>
            <nav>
                <ol className="flex justify-start gap-15 w-full items-center [&_*]:font-mono py-3 pl-7 border-b-2 border-black ">
                    <li className="flex items-center" onClick={() => navigate('/')}>{/* this is main page */}
                    ...
                    <li onClick={()=> navigate('/whyUs')} className="text-[1.3em] font-bold">Why Us?</li>
                    <li onClick={()=> navigate('/features')} className="text-[1.3em] font-bold">Features</li>
                    <li onClick={()=> navigate('/faq')} className="text-[1.3em] font-bold">Faq</li>
